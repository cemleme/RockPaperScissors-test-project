...
var DefaultStateManager = /** @class */ (function () {
     ...
     */
    DefaultStateManager.prototype.modifyAccountFields = function (address, accountFields) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var account;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        account = _e.sent();
                        account.nonce = (_a = accountFields.nonce) !== null && _a !== void 0 ? _a : account.nonce;
                        account.balance = (_b = accountFields.balance) !== null && _b !== void 0 ? _b : account.balance;
                        account.stateRoot = (_c = accountFields.stateRoot) !== null && _c !== void 0 ? _c : account.stateRoot;
                        account.codeHash = (_d = accountFields.codeHash) !== null && _d !== void 0 ? _d : account.codeHash;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.modifyAccountFields(address, { codeHash: codeHash })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
